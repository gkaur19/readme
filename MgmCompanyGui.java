...
default:
// the case where property is valid and created - now display icon
...
private void alertPropertiesArrayFull() {
	displayAlertBox("This Property can not be managed by this company.\n"
			...
			*
			* @return
			true if any of the field related to the property is empty, false
			*
			otherwise
			*/
			...
			*
			* @return
			true if any of the plot fields related to a property is empty, false
			*
			otherwise
			*/
			...
			*
			* @return
			true if any of the field related to the management company is empty,
			*
			false otherwise
			*/
